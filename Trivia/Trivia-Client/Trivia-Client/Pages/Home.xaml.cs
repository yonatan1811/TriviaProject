...
namespace Trivia_Client.Pages
{
    ...
    public partial class Home : UserControl, IContent
    {
        ...
        private bool Connection()
        {
            ...
            if ((Client.Session.CurrentUser != null && Client.Session.CurrentUser.GetSocket() != null) || Client.Session.JustSignedUp)
                return true;
            ...
            try
            {
                ClientSocket.Connect(IPAddress.Loopback, 2223);
                Client.Session.CurrentUser = new Client.User(ClientSocket);
                return true;
            }
        ...
        private void SetConnectionOptions()
        {
            ...
            Window.MenuLinkGroups.ElementAt(0).Links.Add(new FirstFloor.ModernUI.Presentation.Link()
            {
                ...
                Source = new Uri(Client.Paths.SettingsPage, UriKind.Relative)
            });
        }
        ...
        private void SetMenuPage()
        {
            ...
            Window.MenuLinkGroups.ElementAt(0).Links.Add(new FirstFloor.ModernUI.Presentation.Link()
            {
                ...
                Source = new Uri(Client.Paths.JoinRoom, UriKind.Relative)
            });
